...
namespace ProgrammingAssignment2
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            ninja0 = Content.Load<Texture2D>("ninja0");
            ninja1 = Content.Load<Texture2D>("ninja1");
            ninja2 = Content.Load<Texture2D>("ninja2");
            ninja3 = Content.Load<Texture2D>("ninja3");
            ninja4 = Content.Load<Texture2D>("ninja4");

            // STUDENTS: set the currentSprite variable to one of your sprite variables
            currentSprite = ninja0;
        }
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (elapsedTime > CHANGE_DELAY_TIME)
            {
                ...
                //Random.Next return number in the range of "minValue" - "maxValue -1"
                ...
                {
                    currentSprite = ninja1;
                }
                else if (spriteNumber == 2)
                {
                    currentSprite = ninja2;
                }
                else if (spriteNumber == 3)
                {
                    currentSprite = ninja3;
                }
                else if (spriteNumber == 4)
                {
                    currentSprite = ninja4;
                }
