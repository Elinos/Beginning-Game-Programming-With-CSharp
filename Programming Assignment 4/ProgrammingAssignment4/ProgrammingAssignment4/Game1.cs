...
namespace ProgrammingAssignment4
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            int windowXCenter = graphics.PreferredBackBufferWidth / 2;
            int windowYCenter = graphics.PreferredBackBufferHeight / 2;
            board = new Board(Content, windowXCenter, windowYCenter);

            // STUDENTS: CREATE QUIT BUTTON HERE, CENTERED HORIZONTALLY AND WITH A REASONABLE SPACE ABOVE THE BOTTOM OF THE WINDOW
            quitButton = new QuitButton(Content, windowXCenter, graphics.PreferredBackBufferHeight - 70, GameState.Quit);
        }
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (gameState == GameState.Play)
            {
                if (whoseTurn == PlayerType.Human)
                {
                    ...
                    bool moved = board.TakePlayerTurn(mouse);
